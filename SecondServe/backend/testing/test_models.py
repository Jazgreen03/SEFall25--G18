...
class TestUserModel:
    ...
    @pytest.mark.parametrize("role", ["user", "driver", "supplier", "admin"])
    def test_valid_roles_assign_correctly(self, role):
        user = User.objects.create_user(
    ...
    def test_invalid_role_assignment_is_stored_as_is(self):
        ...
        assert user.role == "random_role"  # Stored but invalid logically
    ...
    def test_save_and_reload_preserves_fields(self):
        ...
        assert loaded.email == "reload2@example.com"
...
class TestUserManager:
    ...
    def test_create_user_normalizes_email(self):
        ...
        assert (
            user.email == "Norm@example.com" or user.email == "norm@example.com"
    ...
    def test_create_superuser_sets_flags(self):
        ...
        assert superuser.check_password("adminpw")
